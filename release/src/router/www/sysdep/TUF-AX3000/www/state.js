...
var amesh_support = 1       // GNUton Fix - isSupport("amas");
var ameshRouter_support = 1 //isSupport("amasRouter");
var ameshNode_support = 1   //isSupport("amasNode");
var amesh_wgn_support = 1   //isSupport("amas_wgn");
...
//		banner_code +='<iframe width="0" height="0" frameborder="0" scrolling="no" src="/manifest.asp"></iframe>';
	...
	if(rog_support){
		...
		banner_code +='<div style="margin-left:25px;width:160px;height:52px;margin-top:0px;float:left;" align="left"><span><a href="https://github.com/gnuton/asuswrt-merlin.ng" target="_blank" rel="noreferrer"><img src="images/merlin-logo.png" style="border: 0;"></a></span></div>';
